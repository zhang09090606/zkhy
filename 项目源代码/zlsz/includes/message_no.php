<?php
	function msg_url_no($msg,$url,$type = 0,$limittime=0)
...
.window{width:300px; border:solid 1px #91B7E0; margin:60px auto 0;}
...
.window .tips-box{padding:25px 10px 25px 15px; min-height:70px; height:70px; height:70px; font-size:14px;}
.window .tips-box .tip-icon{width:36px; height:35px; background:url(images/win_tips.png) 0 0 no-repeat; float:left; margin-right:30px;}
.window .tips-box .tip-icon1{width:36px; height:35px; background:url(admin/images/no.png) 0 0 no-repeat; float:left; margin-right:30px;}
.window .tips-box .tip-cont{width:200px; float:left; padding-top:6px;}
