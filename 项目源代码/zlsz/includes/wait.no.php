...
.window .tips-box .tip-icon1{width:36px; height:35px; background:url(admin/images/no.png) 0 0 no-repeat; float:left; margin-right:18px;}
.window .tips-box .tip-cont{width:311px; float:left; padding-top:6px;}
...
<div class="window">
  ...
  <div class="bottom-tips"><span class="login-t">
  <a href="<?php 
  echo $url;
