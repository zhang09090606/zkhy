...
from arcsoft import MRECT,ASVLOFFSCREEN
...
if platform.system() == u'Windows':
    internalLibrary = CDLL(u'\\xampp\htdocs\\zlsz\\python\\libarcsoft_fsdk_face_detection.dll')
else:
    internalLibrary = CDLL(u'\\xampp\htdocs\\zlsz\\python\\libarcsoft_fsdk_face_detection.so')
