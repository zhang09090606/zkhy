...
if platform.system() == u'Windows':
    internalLibrary = CDLL(u'\\xampp\htdocs\\zlsz\\python\\libarcsoft_fsdk_face_recognition.dll')
else:
    internalLibrary = CDLL(u'\\xampp\htdocs\\zlsz\\python\\libarcsoft_fsdk_face_recognition.so')
